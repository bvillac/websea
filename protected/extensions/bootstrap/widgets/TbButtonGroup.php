...
class TbButtonGroup extends CWidget {
    ...
    /**
     * @var boolean indicates whether button is inside a div. Eduardo Cueva 20141503
     */
    public $divContent = true;
    ...
    public function run() {
        ...
        //echo "<script language='JavaScript'>alert('hola xx');</script>"; 
        if($this->divContent)
        ...
        foreach ($this->buttons as $button) {
            ...
            $this->controller->widget('bootstrap.widgets.TbButton', array(
                ...
                'ruta' => isset($button['ruta']) ? $button['ruta'] : null,
                'removeClass' => isset($button['removeClass']) ? $button['removeClass'] : null, /* Agregado por Eduardo Cueva */
                'tooltip' => isset($button['tooltip']) ? $button['tooltip'] : null,
