...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('TotalDescuento')); ?>:</b>
	<?php echo CHtml::encode($data->TotalDescuento); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('Propina')); ?>:</b>
	<?php echo CHtml::encode($data->Propina); ?>
	<br />
