...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('ValorModificacion')); ?>:</b>
	<?php echo CHtml::encode($data->ValorModificacion); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('MotivoModificacion')); ?>:</b>
	<?php echo CHtml::encode($data->MotivoModificacion); ?>
	<br />
